...
if(isset($_GET['acceptcookies'])){setcookie('acceptcookies','1',time()+3600*24*365,'/');}
...
setcookie('blab_options',$options,time()+3600*24*365,'/');
redirect($url);die();}}
...
if(!isset($_COOKIE['blab_xuidc'])){redirect('login.php');die();}
