...
<div id="bbh" style="margin:0;padding:0;cursor:pointer" onclick="switch_p()"></div>
<script type="text/javascript"><!--
...
<div style="color:#fff;background-color:#000;padding:2px;padding-left:8px;padding-right:8px;font-size:9px;font-family:verdana,sans-serif;position:absolute;top:210px"><?php print '<span style="cursor:pointer" onclick="if(parent.document.getElementById(\'ln\')){m=parent.document.getElementById(\'ln\');m.value=m.value+\' /'.$paint_prefix.'\'+'.$q.';m.focus()}" title="'.$lang['insrt'].'">#'.$q.'</span> <b>&middot;</b> '.$lang['author'].': '.$author;?></div>
</body></html>
