...
<div id="bbh" style="margin:0;padding:0"></div>
<div id="p_spi" style="background-color:#000;color:#fff;position:absolute;top:175px;left:200px;font-size:15px;padding:12px;font-weight:bold;display:none">0</div>
...
<div class="paint_plus_minus bgcolor_panel_bars" style="margin-top:0" onmousedown="bwdh(this,1)" onmouseup="this.innerHTML='+';this.style.borderColor='#fff'" onmouseout="this.innerHTML='+';this.style.borderColor='#fff'">+</div>
