...
setcookie('blab_xuidc','',time()+3600*24*365,'/');

/* --- */

if(isset($_POST['check_name'])){
$check_name=abc123($_POST['check_name'],'');
$check_name=neutral_escape($check_name,64,'str');
...
if(isset($postname) && isset($_POST['upass']) && isset($_POST['rpass']) && isset($_POST['email'])){
