...
case 2 :
$create_dv_nmbr='Users Online: <span id="blab_online_nmbr"><b>'.$numonl.'</b></span>';
...
if($mode<>2){die();}
?>
function popusersonline(){
	//document.write('<?php print $create_dv_nmbr.$create_dv_list;?>');
	var elem = document.getElementById('nav-users-online');
	elem.innerHTML = '<?php print $create_dv_nmbr;?>';
}
