...
$message=str_replace('/p%P_NUM%','<span class="link_color" style="text-align:right" onclick="if(parent.document.getElementById(\'ln\')){m=parent.document.getElementById(\'ln\');m.value=m.value+\' /'.$paint_prefix.'%P_NUM%\';m.focus()}"><b>/'.$paint_prefix.'%P_NUM%</b></span>',$lang['post_pntg']);
...
<div style="margin:30px;margin-top:100px;margin-bottom:20px;text-align:justify">
...
<div style="margin-right:30px;float:right;font-weight:bold">
<span class="link_color" onclick="self.location.href='p_paint.php'"><?php print $lang['paint'];?></span>
 ...
 <b><span class="link_color" onclick="if(parent.document.getElementById('ln')){m=parent.document.getElementById('ln');m.value=m.value+' /<?php print $paint_prefix;?>'+<?php print $pid;?>;m.focus()}"><?php print $lang['insrt'];?></span>
&middot;
<span class="link_color" onclick="if(parent.document.getElementById('ln') && typeof parent.close_l == 'function'){parent.chat_post='/<?php print $paint_prefix;?>'+<?php print $pid;?>;parent.close_l();parent.force_dr(1)}"><?php print $lang['postp'];?></span>
&middot;
