...
$(document).ready(function(){
  ...
  // on clicking the 'create user' button within the company appframe
	$(document).on('click', '.btn-login', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/login.php',
  ...
  // on clicking the 'create user' button within the company appframe
    ...
    $.ajax({
      type: 'POST',
      url: 'http://neetchan.com/server/logout.php',
      success: function(data) {
  ...
  // on clicking the 'create user' button within the company appframe
	$(document).on('click', '.btn-create-acc', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/create-account.php',
    		data: $('.user-login-form').serialize(),
    		success: function(data) {
  ...
  // log work on a task
  $(document).on('click', '.submit-log-button', function(e){
    	e.preventDefault();
      console.log('button clicked');
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/submit-work-log.php',
    		data: $('.log-work-form').serialize(),
    		success: function(data) {
    			console.log("POST:log-work SUCCESS");
    			console.log("log-work:data: " + JSON.stringify(data));
          $('.log-work-form').trigger("reset");
    		},
    		error: function(data) {
    			console.log("POST:log-work FAILED");
    			console.log("log-work:data: " + JSON.stringify(data));
    		}
    	});
	});
	...
	$(document).on('click', '.project-create-button', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/submit-project.php',
	...
	$(document).on('click', '.task-create-button', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/submit-task.php',
	...
	$(document).on('click', '.btn-confirm-req', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/confirm-new-user-request.php',
  ...
  // on clicking the 'confirm user request' button (new user) within the company appframe
	$(document).on('click', '.btn-confirm-netreq', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/confirm-network-request.php',
	...
	$(document).on('click', '.btn-new-user-create', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/submit-new-user-request.php',
  ...
  $(document).on('click', '.btn-new-network-create', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/submit-new-network-request.php',
  ...
  // on clicking the 'save' button within user profile appframe
	$(document).on('click', '.button-save-profile', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/save-user-profile.php',
	...
	$(document).on('click', '.button-user-create', function(e){
    	...
    	$.ajax({
    		type: 'POST',
    		url: 'http://neetchan.com/server/admin-create-account.php',
